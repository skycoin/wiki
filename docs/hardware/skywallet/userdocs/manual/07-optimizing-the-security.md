...
Hence, it is essential first to set a PIN code right after you receive your Skywallet. If you want to know more about how to set the PIN code and personalize your Skywallet, please visit the user manual [Personalization of your Skywallet](../03-personalizing-the-wallet).
...
The process is explained in detail in the section [Restore Backup](../06-restoring-backup).
